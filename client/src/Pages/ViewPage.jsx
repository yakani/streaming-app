  ...
  return (
    <div className='flex flex-col bg-robin-900'>
      ...
      <div className='flex justify-center m-2'>
        ...
        <div className="p-2 text-white-50 text-2xl font-sans border shadow-xl shadow-robin-950 rounded-xl border-white m-2" onClick={()=>navigate('/admin')}> films</div>
        <div className="p-2 ">
